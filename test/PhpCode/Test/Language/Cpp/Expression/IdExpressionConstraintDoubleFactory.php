...
/**
 * Represents a factory of doubles for the {@see PhpCode\Test\Language\Cpp\Expression\IdExpressionConstraint} 
 * class.
 * 
 * @author  Christophe Maymard  <christophe.maymard@hotmail.com>
 */
class IdExpressionConstraintDoubleFactory extends AbstractConceptConstraintDoubleFactory
{
    /**
     * {@inheritDoc}
     */
     ...
     * 
     * @param   IdExpression    $idExpr The value of the first argument when matches() is called.
     * @param   bool            $return The value to return when matches() is called.
     * @return  ProphecySubjectInterface
     */
    public function createMatches(IdExpression $idExpr, bool $return): ProphecySubjectInterface
    {
        $prophecy = $this->prophesize();
        
        $this->buildMatches($prophecy, $idExpr, $return);
     ...
     * 
     * @param   IdExpression    $idExpr         The value of the first argument when matches() or failureReason() is called.
    ...
    {
        $prophecy = $this->prophesize();
        $this->buildMatches($prophecy, $idExpr, $matches);
        $this->buildFailureReason($prophecy, $idExpr, $failureReason);
