...
class ParameterDeclarationClauseConstraintDoubleFactory extends AbstractConceptConstraintDoubleFactory
{
     ...
     * 
     * @param   ObjectProphecy              $prophecy       The prophecy to build to.
     * @param   ParameterDeclarationClause  $prmDeclClause  The value of the first argument when failureReason() is called.
